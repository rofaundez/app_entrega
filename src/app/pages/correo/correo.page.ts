...
@Component({
  ...
  standalone: true,
  imports: [TranslateModule,IonButton, IonInput, IonCardTitle, IonCardSubtitle, IonCardHeader, IonCard, IonCardContent, IonContent, IonInput, IonContent, IonCard, IonCardHeader, IonButton, IonCardSubtitle, IonCardTitle, IonCardContent] // Asegúrate de agregar aquí los componentes de Ionic
})
